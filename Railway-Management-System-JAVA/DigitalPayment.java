...
DigitalPayment(){
    ...
    i1= new ImageIcon("D:\\java\\Railway manajment system\\src\\payba.jpg");
    ...
    qr1= new ImageIcon("D:\\java\\Railway manajment system\\src\\pay1.jpg");
    Image img= qr1.getImage().getScaledInstance(200,200,Image.SCALE_AREA_AVERAGING);
    JLabel image= new JLabel(new ImageIcon(img));
    image.setBounds(30,100,200,200);
    image2.add(image);

    qr2= new ImageIcon("D:\\java\\Railway manajment system\\src\\pay2.jpg");
    ...
    ImageIcon i5= new ImageIcon("D:\\java\\Railway manajment system\\src\\digitalpay.jpg");
